...
- [ ] **T1** — Validar 3.1 (expiração do canal) isoladamente, reportar o valor real
...
- [ ] **T7** — Escrever `drive-watch-setup` como function separada + GitHub Action semanal que a chama (renovação do canal)
